...
6. [获取项目的 README 文件](./projects/project/get-the-readme.md)
7. [查看一个项目](./projects/project/get-a-project.md)
8. [获取最近提交信息](./projects/project/get-latest-commit.md)
9. [获取部署配置信息](./projects/deploy/get-deploy-setting.md)
