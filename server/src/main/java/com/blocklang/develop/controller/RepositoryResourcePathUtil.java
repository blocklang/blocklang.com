...
public class RepositoryResourcePathUtil {
	 ...
	 */
	public static List<Map<String, String>> combinePathes(List<RepositoryResource> resources) {
		List<Map<String, String>> stripedParentGroups = new ArrayList<Map<String, String>>();
		String relativePath = "";
		for(RepositoryResource each : resources) {
