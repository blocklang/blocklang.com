...
public class WidgetChangeSetSchemaValidator implements JsonSchemaValidator {

	private static final String SCHEMA_FILE_NAME = "widget_api_change_set_schema.json";
	
	private JsonSchema jsonSchema;
	
	public WidgetChangeSetSchemaValidator() {
