...
@Entity
@Table(name = "api_service_schema", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "api_repo_version_id", "parent_id", "name" }) })
public class ApiServiceSchema extends PartialOperateFields {

	private static final long serialVersionUID = -5994287029085166830L;
