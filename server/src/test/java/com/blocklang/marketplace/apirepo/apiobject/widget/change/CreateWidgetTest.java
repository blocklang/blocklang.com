...
import com.blocklang.marketplace.apirepo.apiobject.widget.change.CreateWidget;
...
public class CreateWidgetTest {
	...
	public void apply_create_one_widget_success() {
		...
		assertThat(context.getChangedObjects().get(0).getId()).isEqualTo(apiObjectId);
	...
	public void apply_create_two_widget_success() {
		...
		assertThat(context.getChangedObjects().get(1).getId()).isEqualTo(apiObjectId);
		assertThat(context.getChangedObjects().get(0).getCode()).isEqualTo("0001");
