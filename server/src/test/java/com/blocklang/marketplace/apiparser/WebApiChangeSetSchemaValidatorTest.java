...
public class WebApiChangeSetSchemaValidatorTest {
	...
	public void run_param_is_null() {
		assertThrows(IllegalArgumentException.class, () -> new WebApiChangeSetSchemaValidator().run(null));
	}
	...
	public void run_no_data() {
		...
		Set<ValidationMessage> errors = new WebApiChangeSetSchemaValidator().run(rootNode);
